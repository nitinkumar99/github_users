...
class ApiClient {
    ...
    dio.interceptors.add(
      InterceptorsWrapper(
        onRequest: (options, handler) {
          ...
          options.contentType = options.headers["User-Agent"] =
  ...
  /// Get repos
  Future<ApiResponse> getUsers(Map<String, dynamic> queryParameters) {
    return _get(UrlPath.getUsers, queryParameters: queryParameters);
  }
